...
To get started with this project, you can clone the repository from [https://github.com/mounirrouissi/microservices-project/tree/master](https://github.com/mounirrouissi/microservices-project/tree/master).
